        ...
        <header className={`${styles.header} ${isMenu ? 'open' : ''}`}>
            <nav className={styles.container}>
                <div className={styles.nav}>
                    ...
                    <p className={styles.logo}><Link href="/" as="document">infomaniak</Link></p>
                                                        ...
                                                        <div className={styles.vignette}>
                                                            <Link href="#">
                                                                <h5>
                                                                    ...
                                                                    kChat <span className={styles.info}>Beto</span></h5>
                                        ...
                                        <div className={styles.leftMenu}>
                                            ...
                                            <div className={styles.sideMenu}>
                                                <div>
                                                    ...
                                                    <div className={styles.actions}>
                                                        <p><Link href="#">Guides et questions <br /> fréquentes →</Link></p>
                                                        <p><Link href="#">Achetez des crédits →</Link></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <li className={`${styles.linkMenu} ${styles.hide_for_mobile}`}><Link href="#">{n("aboutus")}
                            ...
                            <ul className={styles.aboutCollapseMenu}>
                                ...
                                <li>L'équipe
                                    ...
                                    <div className={styles.aboutContainer}>
                                        <figure>
                                            <Image src="/team.png" alt="zelda" width={824} height={660} priority={true} />
                                        </figure>

                                    </div>
                                </li>
                                <li>Engagement écologique
                                    <p>Nous polluons et nous agissons pour atténuer notre <br /> impact</p>
                                    <div className={styles.aboutContainer}>
                                        <figure>
                                ...
                                <li>Presse et communications
                                    <p>Logos , communiqués de presse, etc</p>
                                    <div className={styles.aboutContainer}>
                                        <blockquote>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M0 216C0 149.7 53.7 96 120 96h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V320 288 216zm256 0c0-66.3 53.7-120 120-120h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H320c-35.3 0-64-28.7-64-64V320 288 216z"/></svg>
                                ...
                                <li>Blog et actualités
                                    <p>Découvrez les dernières évolutions de nos services</p>
                                    <div className={styles.aboutContainer}>
                                        <figure>
                                ...
                                <li>Partenaires et revendeurs
                                    <p>Travaillez avec Infomaniak et découvrez tous les <br /> avantages</p>
                                    <div className={styles.aboutContainer}>
                                        <figure>
                ...
                <div className={`${styles.muiBox} ${styles.hide_for_mobile}`}>
                    ...
                    <div className={styles.auth}>
                        <Link href="#" as="document">{l("signup")}</Link>
                        <Link href="#" as="document">{l("loggin")}</Link>
                    </div>
                </div>
            </nav>
            ...
            {isMenu && (
                <div className={`${styles.toggleContainer} ${styles.hide_for_desktop}`}>
                    ...
                    <ul className={styles.toggle}>
                        <li onClick={handleClick} className={styles.linkMenu}>
                            <Link href="#" as="document">{n("products")}
                            </Link>
                            {!isSubmenuOpen ? (
                                <figure>
                        ...
                        <li onClick={handleClick} className={styles.linkMenu}>
                            <Link href="#" as="document">{n("aboutus")}
                            </Link>
                            {!isSubmenuOpen ? (
                                <figure>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
                        ...
                        <li onClick={handleClick} className={styles.linkMenu}>
                            <Link href="#" as="document">{n("support")}
                            </Link>
                            {!isSubmenuOpen ? (
                                <figure>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
                        ...
                        <li onClick={handleClick} className={styles.linkMenu}>
                            <Link href="#" as="document">{n("price")}
                            </Link>
                            <Switch />
                        </li>
                        <li onClick={handleClick} className={styles.linkMenu}>
                            <Link href="#" as="document">{n("language")}
                            </Link>
                            <Dropdown currentLanguage={t('currentLanguage')} currentLanguageFull={t('currentLanguageFull')}  />
                        </li>

                        <div className={styles.auth}>
                            <Link href="#" as="document">{l("signupShort")}</Link>
                            <Link href="#" as="document">{l("logginShort")}</Link>
                        </div>
                    </ul>
                </div>
            )}
