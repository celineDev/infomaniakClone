    ...
    <section className={styles.newsletter}>
        <div className={styles.newsletter_container}>
            <div className={styles.newsletter_titles}>
                <h3>Restez aux premières loges</h3>
            ...
            <form className={styles.newsletter_form}>
                ...
                <div className={styles.newsletter_input}>
                    <input aria-label="Votre email" type="text" placeholder='Entrez votre meilleure adresse mail' />
                ...
                <div className={styles.newsletter_input}>
                    <input aria-label="Votre email" type="text" placeholder='Entrez votre e-mail' />
                    <div className={styles.newsletter_button}>
                        <button>Je m'abonne !</button>
                    </div>
                </div>
