        ...
        <section className={styles.support}>
            <div className={styles.supportContainer}>
                <div>
                    ...
                    <h3>Proche de nos clients et à l'écoute</h3>
                    <p>Une question ou un doute ? Consultez nos ressources ou laissez nos agents du support prendre le relai en toute confiance.
                    <br />
                    <br />
                    Vos retours sont à la base de l'évolution de nos produits. Ici, vous n'êtes pas un numéro.</p>
                    <div className={styles.supportAssistance}>
                        <figure>
                            ...
                            <figcaption>Assistance par chat, téléphone et e-mail</figcaption>
                        </figure>
                        <figure>
                            ...
                            <figcaption>Ressources et questions fréquentes</figcaption>
                        </figure>
                        <figure>
                            ...
                            <figcaption>Documentation pour les développeurs</figcaption>
                        </figure>
                        <figure>
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">{/** Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */}<path d="M256 48C141.1 48 48 141.1 48 256v40c0 13.3-10.7 24-24 24s-24-10.7-24-24V256C0 114.6 114.6 0 256 0S512 114.6 512 256V400.1c0 48.6-39.4 88-88.1 88L313.6 488c-8.3 14.3-23.8 24-41.6 24H240c-26.5 0-48-21.5-48-48s21.5-48 48-48h32c17.8 0 33.3 9.7 41.6 24l110.4 .1c22.1 0 40-17.9 40-40V256c0-114.9-93.1-208-208-208zM144 208h16c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H144c-35.3 0-64-28.7-64-64V272c0-35.3 28.7-64 64-64zm224 0c35.3 0 64 28.7 64 64v48c0 35.3-28.7 64-64 64H352c-17.7 0-32-14.3-32-32V240c0-17.7 14.3-32 32-32h16z"/></svg>
                            <figcaption>Support VIP</figcaption>
                        </figure>
                    </div>
                </div>
            </div>
            <picture className={styles.support_banner}>
                <source
                    media="(max-width: 1250px)"
                    srcSet='/support/support_800.png'
                    sizes="800px"
                />
                <source
                    srcSet='/support/support_1050.png'
                    sizes="1050px"
                />
                <img src='/support/support_1050.png' alt='banner'/>
            </picture>
        </section>
    )
}
