...
const Services = () => {
    ...
    <section className={styles.services}>
        <div className={styles.services_title}>
            ...
            <h2>Nos services évoluent en permanence</h2>
        ...
        {windowWidth > 959 ? (
            <div className={styles.service_cards}>
                <article className={styles.service_card}>
                    <figure>
                        <Image src="/services/service_01.png" alt="" width={390} height={207} />
                    </figure>
                ...
                <article className={styles.service_card}>
                    <figure>
                        <Image src="/services/service_02.png" alt="" width={390} height={207} />
                    </figure>
                    <div className={styles.service_info}>
                        <p>kSuite</p>
                ...
                <article className={styles.service_card}>
                    <figure>
                        <Image src="/services/service_03.png" alt="" width={390} height={207} />
                    </figure>
                    <div className={styles.service_info}>
                        <p>Entreprise</p>
